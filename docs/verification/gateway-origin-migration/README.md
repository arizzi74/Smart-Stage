...
Connection settings**, keeping the existing token. Phones then use its current
QR code. Registered clients intentionally do not follow registration redirects.
